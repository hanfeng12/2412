...
public class UserManager {
    ...
    public User login() {
        ...
        User user = checkAdmin(username, passwd, AdminPath);
        if (AdmincheckLogin) {
            System.out.println("Admin Login successful.");
        } else {
            return checkUser(username, passwd, UserPath);
        }
    ...
    private User checkAdmin(String username, String passwd, String filePath){
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (username.equals(ExpectedUsername) && hashPassword(passwd).equals(ExpectedPasswd)) {
    ...
    private User checkUser(String username, String passwd, String filePath) {
        try {
            BufferedReader reader = new BufferedReader(new FileReader(filePath));
            String line;
            int lineNum = 0;
            while ((line = reader.readLine()) != null) {
                ...
                if (username.equals(ExpectedUsername) && hashPassword(passwd).equals(ExpectedPasswd)) {
                    System.out.println("General user " + username + " login successful.");
